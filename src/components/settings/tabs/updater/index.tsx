    ...
    return (
        <SettingsTab title="ryncord Updater">
            ...
            <FormSwitch
                ...
                description="When enabled, ryncord will automatically download and install updates in the background without asking for confirmation. You'll need to restart Discord to apply the changes."
            ...
            <Paragraph className={Margins.bottom8}>
                This is the GitHub repository where ryncord fetches updates from.
            </Paragraph>
