...
import { DONOR_ROLE_ID, GUILD_ID, IS_MAC, IS_WINDOWS } from "@utils/constants";
        ...
        <SettingsTab title="ryncord Settings">
            {(isEquicordDonor(user?.id)) ? (
                <SpecialCard
                    ...
                    description={
                        isEquicordDonor(user?.id)
                            ? "All ryncord users can see your badge! You can manage your perks by making a ticket in ryncord's server."
                            : ""
                    }
            ...
            <Paragraph className={Margins.bottom16}>
                Configure how ryncord behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
            </Paragraph>
            ...
            <Paragraph className={Margins.bottom16}>
                Configure how ryncord handles notifications. You can customize when and how you receive alerts, or view a history of past notifications.
            </Paragraph>
