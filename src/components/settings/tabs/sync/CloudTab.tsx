...
function EquicordIcon() {
    return <img src="https://blog-v2-46u.pages.dev/favicon.png" alt="ryncord" style={ICON_STYLE} />;
}
...
function CloudTab() {
    ...
    return (
        <SettingsTab>
            ...
            <Paragraph className={Margins.bottom16}>
                Synchronize your ryncord settings to the cloud. This makes it easy to keep your configuration consistent across multiple devices without manual import/export.
            </Paragraph>
